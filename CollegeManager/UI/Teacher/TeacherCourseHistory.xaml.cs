...
namespace View
{
    ...
    public partial class TeacherCourseHistory : Window
    {
        ...
        List<Model.TeacherCourseHistory> Courses = new List<Model.TeacherCourseHistory>();
        readonly List<Model.TeacherCourseHistory> CoursesCopy = new List<Model.TeacherCourseHistory>();
        ...
        public TeacherCourseHistory(int teacherID)
        {
            ...
            Courses = (List<Model.TeacherCourseHistory>)App.logic.GetFromDB("GetTeacherHistoryByID", new object[] { teacherID });
        ...
        private void Search()
        {
            List<Model.TeacherCourseHistory> SearchResult = PageLogic.SearchTeacherCourseHistory(Checkbox_SearchPastCourse.IsChecked,
